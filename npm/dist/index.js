...
class Binary {
    ...
    static async create(name, path, destination) {
        var _a;
        let installDir = (_a = destination !== null && destination !== void 0 ? destination : (await (0, utils_1.searchPath)(name))) !== null && _a !== void 0 ? _a : Binary.DEFAULT_INSTALL_DIR;
    ...
    download(url) {
        return pipeline(got_1.default.stream(url), new stream.PassThrough(), tar.x({ C: this.installDir }));
    }
    async install() {
